  ...
  $.fn.easySelect = function (options) {
    ...
    $.fn.easySelect1 = function (options) {
        return this.each(function () {
            ...
            var $listItems = $list.find("li");
            var checkItem = $list.find(".mulpitply_checkbox_style1");
            ...
            function eachItem() {
                arrText = [];
                $.each($list.find(".mulpitply_checkbox_style1:checked"), function () {
                    arrText.push($(this).parent().text());
                });
            }
            ...
            $listItems.click(function (e) {
                ...
                val = [];
                $(".mulpitply_checkbox_style1:checked").each(function () {
                    val.push($(this).val());
                });
                $this.closest("select").val(val);
                ...
                arrVal = [];
                var getVal = $.each(
                    $(".mulpitply_checkbox_style1:checked"),
                    function () {
                        arrVal.push($(this).val());
                    }
                );
            ...
            // ============Set preselected items on plugin init===================
            arrVal = [];
            var getVal = $.each($(".mulpitply_checkbox_style1:checked"), function () {
                //debugger;
                arrVal.push($(this).val());
            });
            eachItem();
